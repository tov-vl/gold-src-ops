...
controlled game-server baseline contract, while infrastructure purchase,
provider selection, provisioning, and target-environment evidence remain
pending.
...
`docs/v2.3-controlled-gameserver-baseline.md`. No provider or external server
