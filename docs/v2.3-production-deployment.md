...
automation are also implemented and exercised by `Container Smoke`.
Infrastructure purchase, pre-purchase verification, off-host repository
execution, provisioning, and all target-environment evidence remain pending.
