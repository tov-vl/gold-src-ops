...
7. In progress: the controlled MyArena game VDS, provider-independent host
   ...
   service remains disabled and inactive. Complete controlled activation, then
   verify external A2S, guarded RCON, address stability, source-address
   preservation, and ReHLDS recovery.
