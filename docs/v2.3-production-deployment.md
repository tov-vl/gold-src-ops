...
1. Integrate the read-only host-readiness audit and deployment checklist.
2. Publish immutable release-candidate images such as `v2.3.0-rc.1` to GHCR
   without treating them as stable releases.
