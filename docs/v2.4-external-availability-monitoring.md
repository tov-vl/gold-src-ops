...
evidence-integrity failure. Alert routing and a fresh contiguous 24-hour shadow
audit under that policy remain pending before the prospective `API-01`
activation window can begin.
