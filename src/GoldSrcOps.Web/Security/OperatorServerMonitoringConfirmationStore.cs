...
internal sealed class OperatorServerMonitoringConfirmationStore(TimeProvider timeProvider)
{
    ...
    private static void ValidateAction(OperatorServerMonitoringAction action)
    {
...
internal enum OperatorServerMonitoringAction
{
    Enable,
    Disable
}
