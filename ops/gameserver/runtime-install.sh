...
ExecStart=$service_home/server/hlds_run -game cstrike -console -strictportbind -ip 0.0.0.0 -port $game_port +servercfgfile goldsrcops-public.cfg +maxplayers 4 +map de_dust2
